...
public class ExemploFile {
	...
	// Diretório pai
	// "existe": "não existe"
	// "pode ser gravado" : "não pode ser gravado"
	// "pode ser lido" : "não pode ser lido"
	// "é diretório": "não é diretório"
	// formatar data dia/mês/ano
	// lastModified
	// "Ultima modificação no arquivo"
	// tamanho do arquivo: "codigo" + "bytes."
